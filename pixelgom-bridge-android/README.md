...
| 다음 준비 AAB | `1.0.27` / versionCode `28` |
...
7. Android 1.0.27 이상에서는 입력칸 주변에서 연결코드 찾기/복사를 바로 열 수 있고, 일반방 연결코드 1번으로 연결된 게임방까지 자동 등록됩니다. 카카오 알림에 발신자명이 분리되어 들어오지 않는 경우에도 텍스트 라인에서 발신자를 보강합니다.
