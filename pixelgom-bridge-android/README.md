...
| 다음 준비 AAB | `1.0.28` / versionCode `29` |
...
7. Android 1.0.28 이상에서는 입력칸 주변에서 연결코드 찾기/복사를 바로 열 수 있고, 일반방 연결코드 1번으로 연결된 게임방까지 자동 등록됩니다. 대표방은 일반방으로 표시하고 게임방은 접기/펼치기 목록에서 전체 등록 방을 확인할 수 있습니다.
