...
실사용에서는 `/실시간순위` 또는 `/방순위`를 가장 자주 쓰면 됩니다. 오늘 참여자 수, 채팅 수, 타수, 타수 TOP5, 채팅 TOP5를 한 번에 보여줍니다. 사람들이 `/랭킹`, `/순위`, `/오늘순위`처럼 입력해도 같은 화면이 나옵니다. 개인 현재 등수는 `/내순위`로 확인합니다.
...
대장간 제련: 철광석 1개 + 40P, 장비 120종 중 획득
