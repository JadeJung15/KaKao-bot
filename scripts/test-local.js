...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.42");
  assert.equal(health.json.latestAndroidVersionCode, 43);
  ...
  assert.match(androidGradle, /versionCode 43/);
  assert.match(androidGradle, /versionName "1\.0\.42"/);
