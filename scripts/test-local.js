...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.43");
  assert.equal(health.json.latestAndroidVersionCode, 44);
  ...
  assert.match(androidGradle, /versionCode 44/);
  assert.match(androidGradle, /versionName "1\.0\.43"/);
