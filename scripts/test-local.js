...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.50");
  assert.equal(health.json.latestAndroidVersionCode, 51);
  ...
  assert.match(androidGradle, /versionCode 51/);
  assert.match(androidGradle, /versionName "1\.0\.50"/);
