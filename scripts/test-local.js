...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.53");
  assert.equal(health.json.latestAndroidVersionCode, 54);
  ...
  assert.match(androidGradle, /versionCode 54/);
  assert.match(androidGradle, /versionName "1\.0\.53"/);
