...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.51");
  assert.equal(health.json.latestAndroidVersionCode, 52);
  ...
  assert.match(androidGradle, /versionCode 52/);
  assert.match(androidGradle, /versionName "1\.0\.51"/);
