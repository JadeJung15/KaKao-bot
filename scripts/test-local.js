...
try {
  ...
  assert.equal(health.json.latestAndroidVersion, "1.0.52");
  assert.equal(health.json.latestAndroidVersionCode, 53);
  ...
  assert.match(androidGradle, /versionCode 53/);
  assert.match(androidGradle, /versionName "1\.0\.52"/);
